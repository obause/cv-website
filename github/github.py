...
class Queries(object):
    ...
    async def query(self, generated_query: str) -> Dict:
        ...
        try:
            ...
            print("aiohttp failed for GraphQL query: ", e)
    ...
    async def query_rest(self, path: str, params: Optional[Dict] = None) -> Dict:
        ...
        for _ in range(60):
            ...
            try:
                ...
                print("aiohttp failed for rest query: ", e)
                # Fall back on non-async requests
                async with self.semaphore:
...
async def main() -> None:
    ...
    access_token = settings.get_secret("GITHUB_ACCESS_TOKEN")
    user = settings.get_secret("GITHUB_USER")
